...
val Cyan50 = Color(0xffe3f6f9)
val Cyan100 = Color(0xffbbe9ee)
val Cyan200 = Color(0xff93dbe4)
val Cyan300 = Color(0xff74cbd8)
val Cyan400 = Color(0xff67c0ce)
val Cyan500 = Color(0xff64b5c5)
val Cyan600 = Color(0xff5ea6b3)
val Cyan700 = Color(0xff56919a)
val Cyan800 = Color(0xff4f7c82)
val Cyan900 = Color(0xff3e5a5b)

val Sky50 = Color(0xffe6eff8)
val Sky100 = Color(0xffc2d6ee)
val Sky200 = Color(0xff9fbde2)
val Sky300 = Color(0xff7da4d7)
val Sky400 = Color(0xff6792d4)
val Sky500 = Color(0xff5681ce)
val Sky600 = Color(0xff5174c1)
val Sky700 = Color(0xff4963ae)
val Sky800 = Color(0xff42539c)
val Sky900 = Color(0xff34367e)

val DarkPrimaryColor = Color(0xff142d38)
val DarkPrimaryLightColor = Color(0xff3e5662)
val DarkPrimaryDarkColor = Color(0xff000212)
val DarkSecondaryColor = Color(0xff67c1ce)
val DarkSecondaryLightColor = Color(0xff9bf4ff)
val DarkSecondaryDarkColor = Color(0xff30909d)
val DarkPrimaryTextColor = Color(0xffffffff)
val DarkSecondaryTextColor = Color(0xff000000)

val PrimaryColor = Color(0xff67c0ce) // Cyan400
val PrimaryLightColor = Color(0xff9bf4ff)
val PrimaryDarkColor = Color(0xff30909d)
val SecondaryColor = Color(0xff9fbde2)
val SecondaryLightColor = Color(0xffd1efff)
val SecondaryDarkColor = Color(0xff6f8db0)
