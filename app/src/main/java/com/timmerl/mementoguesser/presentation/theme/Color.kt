...
val blueLight = Color(color = 0xff63a4ff)
val lightGrey = Color(color = 0xffcfd8dc)
val brown = Color(color = 0xff8d6e63)
val sand = Color(color = 0xffbe9c91)
val sandLight = Color(color = 0xffbcaaa4)
val appError = Color(color = 0xffB00020)
val darkBrown = Color(color = 0xff5f4339)
